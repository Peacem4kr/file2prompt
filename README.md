...
- Running [Ollama](https://github.com/ollama/ollama/blob/main/README.md) server or compatible LLM API with token-based authentication (https://github.com/ollama/ollama/blob/main/README.md)  
